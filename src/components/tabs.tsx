        ...
        <Tab.Group>
            <div className="flex items-center ">
                <Tab.List className="px-4 pt-4">
                    <div className="flex py-2 px-2 border rounded-xl border-[#E6E6E6]">
                        <Tab as={Fragment}>
                            {({ selected }) => (
                                <button
                                    className={
                ...
                <div className="text-pink pt-4 tracking-[0.030em] lg:text-3xl text-xl font-onest">
                    How to earn 🍩 donut points?
                </div>
            </div>
